...
if(isset($_GET['pid']) && filter_var($_GET['pid'],FILTER_VALIDATE_INT,  array('min_range'=>1)))
{
 // check for a print id.
    ...
    if(isset($_SESSION['cart'][$pid]))
    {
        ...
        // display a message
        echo '<p>Another copy of the print has been add to your shopping cart</p><br><a href="browse_prints.php">Back</a>';
    }
    else
    {
        ...
        if(mysqli_num_rows($r)==1)
        {
            ...
            // Display a message
            echo '<p style="text-align:center"> print has been added to shopping cart<br><a href="browse_prints.php">Back</a>';
